...
set output "plots/gcounter_troughput.tex"
...
plot "data/SMPC/gcounter/update_troughput.dat" using 1:($2/100) with linespoints title "GCounter" ls line_style lw line_width pt marker_1 ps point_size lc rgb gcounter_color
