...
set ylabel "Throughput (ops/s * 100)" offset screen 0.05,0
...
set output "plots/register_troughput.tex"
...
plot "data/SMPC/register/update_troughput.dat" using 1:($2/100) with linespoints title "Register" ls line_style lw line_width pt marker_1 ps point_size lc rgb gcounter_color
